...
export default function LifestyleTransformationContent() {
  ...
  return (
    <div className="container w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-6 h-screen relative">
      ...
      <Image
        ...
        width="788"
        height="960"
        className="h-full object-contain absolute bottom-0 left-0 w-[42%] max-w-[520px] z-0 hidden lg:block"
      />
