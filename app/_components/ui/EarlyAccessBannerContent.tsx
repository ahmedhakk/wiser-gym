...
export default function EarlyAccessBannerContent() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10 text-white h-full">
      <div className="flex h-full flex-col py-10 lg:py-14 justify-between">
        <div className="grid gap-10 md:grid-cols-2 md:gap-12 mt-16 rtl:text-right">
          {/* Left side */}
        ...
        <div className="flex justify-center pb-6">
          <AnimateOnScroll direction="up" delayMs={300}>
            <button
              type="button"
              className="inline-flex items-center justify-center rounded-sm bg-white px-6 py-3 text-center text-base font-semibold tracking-wide text-gray-900 shadow-lg sm:px-10 sm:text-lg md:text-2xl"
            >
              {t("cta")}
            </button>
          </AnimateOnScroll>
